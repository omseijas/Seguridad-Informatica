...
//Calcular la caducidad de la cookie
  expdate.setTime(expdate.getTime() +  (24 * 60 * 60 * 1000 * 365));

//Comprobar si hay una cookie, y si no la hay, ponerla
//Si la hay, se incrementa el contador y se muestra un mensaje

  if(!(visit = GetCookie("contador")))
  visit = 0;
  visit++;
  SetCookie("contador", visit, expdate, "/", null, false);
  var message;
  if(visit == 1)
